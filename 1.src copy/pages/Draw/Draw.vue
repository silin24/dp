<template>
  <div class="draw">
    ...
    <div class="drawFooter">
      <div>
        <button class="deployTurn ">配置轮次</button>
        <button class="resetDraw">重置抽奖</button>
        <button class="clearTrun" @click="showkQrCode">清空轮次</button>
        <button class="start" @click="showkQrCode">开始</button>
        <button class="win" @click="showkQrCode">获奖名单</button>
      </div>
      <span>
        活动支持: 螃蟹科技
      </span>
