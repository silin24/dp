  ...
  <div class="sign">
    ...
    <div class="signBody">
      <div class="signPerson">
        <div class="signColumn">
          <div v-for="(item,index) in reUserList[0]" :key="index">
            <img :src="item.avator" alt="">
          </div>
          <div v-for="(item,index) in reUserList[1]" :key="index">
            <img :src="item.avator" alt="">
          </div>
          <div v-for="(item,index) in reUserList[2]" :key="index">
            <img :src="item.avator" alt="">
          </div>
        </div>
      </div>
    ...
    computed:{
      ...
      reUserList () {
        if (this.userlist.length > 0) {
         return _.chunk(this.userlist, 7)
        } else {
          console.log(11);
         return _.chunk(this.userList, 7)
        }
